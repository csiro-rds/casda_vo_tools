 ...
 * 
 * <p>Java class for posAngleType complex type.
 * 
...
@XmlType(name = "posAngleType", propOrder = {
    "value"
})
public class PosAngleType {
     ...
     * @return
     *     possible object is
     *     {@link PosAngleReferenceType }
     *     
     */
    public PosAngleReferenceType getReference() {
        if (reference == null) {
            return PosAngleReferenceType.X;
        } else {
            return reference;
        }
    }

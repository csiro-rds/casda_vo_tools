...
public class PGSphereHealth extends Configurable implements HealthIndicator
{
     ...
     */
    @Autowired
    public PGSphereHealth(ConfigurationRegistry configRegistry) throws ConfigurationException
    {
    ...
    public Health health()
    {
        try
        {
            if (!isReady())
            {
                throw new ConfigurationException("PGSphereHealth is not configured.");
            }
